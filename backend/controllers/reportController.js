...
export const downloadTicketReport = asyncHandler(async (req, res, next) => {
    // **** MANUAL CORS HEADERS REMOVED - Rely on global CORS middleware ****
    ...
    try {
        ...
        // Set Content-Disposition and Content-Type specific to the file response
        ...
        if (reportFormat === 'csv') {
            ...
            res.status(200).send(headerString + recordsString);
        }
