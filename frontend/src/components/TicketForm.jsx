...
// // import "../../src/App.css"; // Consider if this is needed, and adjust path
// // import "../../src/index.css"; // Consider if this is needed, and adjust path
...
//     try {
//       const response = await axios.post(`${backendURL}/api/tickets`, formData); // Use environment variable
...
// //  tkt/frontend/sec/components/TicketForm.jsx.jsx
...
// //         try {
// //             const response = await axios.post(import.meta.env.VITE_BACKEND_URL + "/api/tickets", 
// //             formData); // Updated API call
