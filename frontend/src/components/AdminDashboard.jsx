                    ...
                    {!showTickets && !showUserUpload && !showTicketForm && (
                        ...
                        >
                            ...
                            <div className={`rounded-2xl shadow-md p-4 flex flex-col items-start ${darkMode ? "bg-gray-800 text-white" : "bg-white text-gray-700"}`}>
                                <div className="text-lg font-semibold mb-1">Total Tickets</div>
                            ...
                            >
                                <div className="text-lg font-semibold mb-1">Open <FaExclamationTriangle className="inline ml-1" /></div>
                            ...
                            >
                                <div className="font-raleway text-lg font-semibold mb-1">In Progress <FaSpinner className="inline ml-1 animate-spin" /></div>
